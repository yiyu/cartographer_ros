...
class MapBuilderBridge {
 public:
  ...
  void Write3DAssets(const std::string& stem);
  ...
  //james test 
  visualization_msgs::MarkerArray GetHaloTrajectoryNodesList();
  geometry_msgs::PoseArray GetHaloPoseList();
  geometry_msgs::PoseArray GetHaloImuList();
  ///
 private:
